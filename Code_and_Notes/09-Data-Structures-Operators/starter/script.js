...
console.log(maskCreditCard(64378655));
console.log(maskCreditCard(43378463864647384));
console.log(maskCreditCard('35353560603232323'));
...
// const lowerEmail = loginEmail.toLowerCase();    // Can simplify using it all at once.
...
console.log(airline.indexOf('portugal')); // Does not find!!!
...
// JavaScript uses Boxing on the string to put it in an object, so that methods will work. Then it is converted back to String Primitive.
...
// const players1 = [...game.players[0]];     //  MY SOLUTION
// const players2 = [...game.players[1]];
// console.log(players1);
// console.log(players2);

// TASK 2 - 2. The first player in any player array is the goalkeeper and the others are field players. For Bayern Munich (team 1) create one variable ('gk') with the goalkeeper's name, and one array ('fieldPlayers') with all the remaining 10 field players
...
const printGoals = function (...players) {
  console.log(`${players.length} goals were scored by the players ${players}`);
...
const odds = Object.values(game.odds); // Solution in video
let average = 0;
for (const odd of odds) average += odd;
average /= odds.length;
console.log(average);

// const odds1 = Object.values(game.odds); // My solution
// const oddsAverage = function (odds) {
//   let sum = 0;
//   for (const [i, value] of odds.entries()) {
//     sum += value;
//   }
//   return sum / odds.length;
// };
// console.log(oddsAverage(odds));
...
// console.log(`Odd of victory ${game.team1}: ${game.odds.team1}`);  // I Cheated on this one, apparently.
...
for (let x of game.scored) {
  scorers2[x]++ || (scorers2[x] = 1);
}
console.log(scorers2);

// const [...scorePlayers] = game.scored;                   // Nothing I tried was really working, and it was overly complicated

// const removeDuplicates = arr => [...new Set(arr)];

// removeDuplicates(scorePlayers);
...
//   arr.reduce((a, v) => (v === value ? a + 1 : a), 0); // Number of Occurences
...
// nullish assignmnet operator (null or undefined)
rest1.numGuests ??= 10;
rest2.numGuests ??= 10;
...
// Iterables are arrays, strings, maps, sets. NOT onjects
const str = 'Jonas';
const letters = [...str, ' ', 'S.'];
console.log(letters);
console.log(...str);
// console.log(`${...str} Schmedtmann`); // Not expecting multiple values here, so it will come up as an error.
...
// const avgEventTime = 90 / eventTimes.length;
// const avgEventTime = 90 / [...gameEvents.keys()].length;
...
//     const textFixed = function () {
//       const textLower = rows[i].toLowerCase().trim();
//       const [first, secondUpper] = textLower.split('_');
//       const textCamel = [];
//       textCamel.push(first);
//       textCamel.push(
//         secondUpper.replace(secondUpper[0], secondUpper[0].toUpperCase())
//       );
//       console.log(`${textCamel.join('')} ${'✅'.repeat(i + 1)}`);
//     };
//     textFixed(text);
//   }
// });
